...
public class clsCompras {
    ...
    public clsCompras(int AcreCodigo, String AcreNombre, String AcreNit,
    ...
    // INSERT
    public int setIngresarAcreedor(clsCompras acreedor) {
    ...
    // SELECT por Codigo
    public clsCompras getBuscarAcreedorPorId(clsCompras acreedor) {
        AcreedorDAO daoAcreedor = new AcreedorDAO();
        return daoAcreedor.consultaAcreedorPorId(acreedor);
    }

    // SELECT por Nombre
    public List<clsCompras> getBuscarAcreedoresPorNombre(clsCompras acreedor) {
        AcreedorDAO daoAcreedor = new AcreedorDAO();
        return daoAcreedor.consultaAcreedoresPorNombre(acreedor);
    }

    // SELECT por NIT
    public clsCompras getBuscarAcreedorPorNit(clsCompras acreedor) {
        AcreedorDAO daoAcreedor = new AcreedorDAO();
        return daoAcreedor.consultaAcreedorPorNit(acreedor);
    }

    // SELECT por Estado
    public List<clsCompras> getBuscarAcreedoresPorEstado(clsCompras acreedor) {
        AcreedorDAO daoAcreedor = new AcreedorDAO();
        return daoAcreedor.consultaAcreedoresPorEstado(acreedor);
    }

    // UPDATE
    public int setModificarAcreedor(clsCompras acreedor) {
        AcreedorDAO daoAcreedor = new AcreedorDAO();
        return daoAcreedor.actualizaAcreedor(acreedor);
    }

    // DELETE
    public int setBorrarAcreedor(clsCompras acreedor) {
        AcreedorDAO daoAcreedor = new AcreedorDAO();
